package com.dupake.gatewayserver.exception;
...
//        result.put("body",body);
        ...
        Function<ServerRequest, Mono<ServerResponse>> renderErrorResponse = this::renderErrorResponse;
